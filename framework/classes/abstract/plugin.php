...
abstract class akPluginAbstract extends akModuleAbstract
{
	 ...
	 * @return void
	 */
	abstract protected function pluginActivate ();

	/**
	 * Fires on plugin deactivation.
	 * @return void
	 */
	abstract protected function pluginDeactivate ();
	 ...
	 * @return void
	 */
	abstract protected function pluginUpdate ( $version );

	/**
	 * Fires when plugins have been loaded.
	 * @return void
	 */
	abstract protected function pluginsLoaded ();

	/**
	 * Fires on Widgets init.
	 * @return void
	 */
	abstract protected function registerWidgets ();
